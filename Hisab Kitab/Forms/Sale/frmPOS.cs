        ...
        private void LoadGroupPanel()
        {
            ...
            if (clsUtility.sqlDT.Rows.Count > 0)
            {
                ...
                for (i = 0; i <= clsUtility.sqlDT.Rows.Count - 1; i++)
                {
                    ...
                    grpButton.Image = HisabKitab.Properties.Resources.shopping_cart;
        ...
        private void LoadProductPanel(string GROUP_ID)
        {
            ...
            if (clsUtility.sqlDT.Rows.Count > 0)
            {
                ...
                for (i = 0; i <= clsUtility.sqlDT.Rows.Count - 1; i++)
                {
                    ...
                    catch (Exception) { picturebx.Image = resizeImage(HisabKitab.Properties.Resources.No_image_found, new Size(74, 71)); }
